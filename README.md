...
Use the latest ZIP from the **Releases** section:
...
Используйте свежий ZIP из раздела **Releases**:

[Скачать последнюю версию](https://github.com/IamQbcle/wt-roster-manager/releases)

В репозитории также лежат рабочие файлы проекта, но ZIP из Releases — самый простой способ скачать программу.

## Обратная связь

Вопросы, идеи и багрепорты:
